...
- **Next steps**: proceed to UI Step 4 visual polish (card hierarchy, typography rhythm, meaningful motion) on top of the new home IA while keeping current behavior contracts intact.
