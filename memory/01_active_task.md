...
## Context
- **Recent achievements**: `dividends-csv` and `sinopac-stock` now both rely on shared parser/batch/holding helpers instead of carrying their own route-local duplicate logic.
